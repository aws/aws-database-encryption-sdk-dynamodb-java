...
func (_static *CompanionStruct_Default___) DynamoDbItemEncryptor(config m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DynamoDbItemEncryptorConfig) m_Wrappers.Result {
	...
	_ = _7_attributeNames
	_7_attributeNames = m_SortedSets.SetToOrderedSequence2(((config).Dtor_attributeActionsOnEncrypt()).Keys(), func(coer22 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg29 interface{}, arg30 interface{}) bool {
			return coer22(arg29.(_dafny.Char), arg30.(_dafny.Char))
		}
	...
	_ = _12_valueOrError4
	_12_valueOrError4 = (_11_structuredEncryptionRes).MapFailure(func(coer23 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg31 interface{}) interface{} {
			return coer23(arg31.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	if ((config).Dtor_cmm()).Is_Some() {
		...
		if !(!((_18_valueOrError5).IsFailure())) {
			panic("/Users/rishavkj/Documents/Storage/Team-Repos/aws-database-encryption-sdk-dynamodb/DynamoDbEncryption/dafny/DynamoDbItemEncryptor/src/Index.dfy(158,21): " + (_18_valueOrError5).String())
		}
		...
		_ = _21_valueOrError6
		_21_valueOrError6 = (_20_maybeCmm).MapFailure(func(coer24 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
			return func(arg32 interface{}) interface{} {
				return coer24(arg32.(m_AwsCryptographyMaterialProvidersTypes.Error))
			}
	...
	_ = _26_valueOrError8
	_26_valueOrError8 = (_23_maybeCmpClient).MapFailure(func(coer25 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg33 interface{}) interface{} {
			return coer25(arg33.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
