// Package EncryptManifest
// Dafny module EncryptManifest compiled into Go
...
func (*Default__) String() string {
	return "EncryptManifest.Default__"
}
...
func (_static *CompanionStruct_Default___) Manifest() _dafny.Tuple {
	var _0_result _dafny.Sequence = _dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(m_WriteManifest.Companion_Default___.DECRYPT__TYPE())), _dafny.TupleOf(_dafny.SeqOfString("version"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("1"))))
	_ = _0_result
	return _dafny.TupleOf(_dafny.SeqOfString("manifest"), m_JSON_Values.Companion_JSON_.Create_Object_(_0_result))
}
func (_static *CompanionStruct_Default___) Client(lang _dafny.Sequence, version _dafny.Sequence) _dafny.Tuple {
	var _0_result _dafny.Sequence = _dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("name"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.Companion_Sequence_.Concatenate(m_WriteManifest.Companion_Default___.LIB__PREFIX(), lang))), _dafny.TupleOf(_dafny.SeqOfString("version"), m_JSON_Values.Companion_JSON_.Create_String_(version)))
	_ = _0_result
	return _dafny.TupleOf(_dafny.SeqOfString("client"), m_JSON_Values.Companion_JSON_.Create_Object_(_0_result))
}
func (_static *CompanionStruct_Default___) OnePositiveTest(name _dafny.Sequence, theType _dafny.Sequence, desc _dafny.Sequence, config m_JSON_Values.JSON, decryptConfig m_Wrappers.Option, record m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf(_dafny.EmptySeq.SetString(), m_JSON_Values.Companion_JSON_.Default()))
	_ = output
	var _0_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JsonConfig.Companion_Record_.Default())
	_ = _0_valueOrError0
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_JsonConfig.Companion_Default___.GetRecord(record)
	_0_valueOrError0 = _out0
	if (_0_valueOrError0).IsFailure() {
		output = (_0_valueOrError0).PropagateFailure()
		return output
	}
	var _1_rec m_JsonConfig.Record
	_ = _1_rec
	_1_rec = (_0_valueOrError0).Extract().(m_JsonConfig.Record)
	var _2_valueOrError1 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _2_valueOrError1
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_JsonConfig.Companion_Default___.GetItemEncryptor(name, config)
	_2_valueOrError1 = _out1
	if (_2_valueOrError1).IsFailure() {
		output = (_2_valueOrError1).PropagateFailure()
		return output
	}
	var _3_encryptor *m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient
	_ = _3_encryptor
	_3_encryptor = (_2_valueOrError1).Extract().(*m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient)
	...
	_ = _out2
	_out2 = (_3_encryptor).EncryptItem(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_EncryptItemInput_.Create_EncryptItemInput_((_1_rec).Dtor_item()))
	_4_valueOrError2 = _out2
	if !(!((_4_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(49,21): " + (_4_valueOrError2).String())
	}
	var _5_encrypted m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.EncryptItemOutput
	_ = _5_encrypted
	_5_encrypted = (_4_valueOrError2).Extract().(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.EncryptItemOutput)
	var _6_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _6_valueOrError3
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = m_DdbItemJson.Companion_Default___.DdbItemToJson((_5_encrypted).Dtor_encryptedItem())
	_6_valueOrError3 = _out3
	if !(!((_6_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(54,16): " + (_6_valueOrError3).String())
	}
	var _7_item m_JSON_Values.JSON
	_ = _7_item
	_7_item = (_6_valueOrError3).Extract().(m_JSON_Values.JSON)
	var _8_result _dafny.Sequence
	_ = _8_result
	_8_result = _dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(theType)), _dafny.TupleOf(_dafny.SeqOfString("description"), m_JSON_Values.Companion_JSON_.Create_String_(desc)), _dafny.TupleOf(_dafny.SeqOfString("config"), (func() m_JSON_Values.JSON {
		if (decryptConfig).Is_Some() {
			return (decryptConfig).Dtor_value().(m_JSON_Values.JSON)
		}
		return config
	})()), _dafny.TupleOf(_dafny.SeqOfString("plaintext"), record), _dafny.TupleOf(_dafny.SeqOfString("encrypted"), _7_item))
	output = m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(name, m_JSON_Values.Companion_JSON_.Create_Object_(_8_result)))
	return output
	return output
}
func (_static *CompanionStruct_Default___) OneNegativeTest(name _dafny.Sequence, config m_JSON_Values.JSON, record m_JSON_Values.JSON) m_Wrappers.Result {
	...
	_ = _3_encryptor
	_3_encryptor = (_2_valueOrError1).Extract().(*m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient)
	var _4_encrypted m_Wrappers.Result
	_ = _4_encrypted
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_3_encryptor).EncryptItem(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_EncryptItemInput_.Create_EncryptItemInput_((_1_rec).Dtor_item()))
	_4_encrypted = _out2
	if (_4_encrypted).Is_Success() {
		output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Test "), name), _dafny.SeqOfString(" failed to fail to encrypt.")))
		return output
	}
...
func (_static *CompanionStruct_Default___) OneTest(name _dafny.Sequence, value m_JSON_Values.JSON) m_Wrappers.Result {
	...
	var _4_decryptConfig m_Wrappers.Option
	_ = _4_decryptConfig
	_4_decryptConfig = m_Wrappers.Companion_Option_.Create_None_()
	var _5_record m_Wrappers.Option
	_ = _5_record
	_5_record = m_Wrappers.Companion_Option_.Create_None_()
	...
	for _6_i := _dafny.Zero; _6_i.Cmp(_hi0) < 0; _6_i = _6_i.Plus(_dafny.One) {
		...
		_ = _source0
		{
			...
			{
				if (_source0).Equals(_dafny.SeqOfString("decryptConfig")) {
					var _11_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _11_valueOrError4
					_11_valueOrError4 = m_Wrappers.Companion_Default___.Need(((*(_7_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'decryptConfig' must be an object."))
					if (_11_valueOrError4).IsFailure() {
						output = (_11_valueOrError4).PropagateFailure()
						return output
					}
					_4_decryptConfig = m_Wrappers.Companion_Option_.Create_Some_((*(_7_obj).IndexInt(1)).(m_JSON_Values.JSON))
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("record")) {
					...
					_5_record = m_Wrappers.Companion_Option_.Create_Some_((*(_7_obj).IndexInt(1)).(m_JSON_Values.JSON))
					goto Lmatch0
				}
			}
			{
	...
	_ = _16_valueOrError9
	_16_valueOrError9 = m_Wrappers.Companion_Default___.Need((_5_record).Is_Some(), _dafny.SeqOfString("Test requires a 'record' member."))
	if (_16_valueOrError9).IsFailure() {
		output = (_16_valueOrError9).PropagateFailure()
		return output
	}
	if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("positive-encrypt")) {
		var _17_valueOrError10 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf(_dafny.EmptySeq.SetString(), m_JSON_Values.Companion_JSON_.Default()))
		_ = _17_valueOrError10
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.OnePositiveTest(name, _dafny.SeqOfString("positive-decrypt"), (_2_description).Dtor_value().(_dafny.Sequence), (_3_config).Dtor_value().(m_JSON_Values.JSON), _4_decryptConfig, (_5_record).Dtor_value().(m_JSON_Values.JSON))
		_17_valueOrError10 = _out0
		if (_17_valueOrError10).IsFailure() {
			output = (_17_valueOrError10).PropagateFailure()
			return output
		}
		var _18_x _dafny.Tuple
		_ = _18_x
		_18_x = (_17_valueOrError10).Extract().(_dafny.Tuple)
		output = m_Wrappers.Companion_Result_.Create_Success_(m_Wrappers.Companion_Option_.Create_Some_(_18_x))
		return output
	} else if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("negative-decrypt")) {
		var _19_valueOrError11 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf(_dafny.EmptySeq.SetString(), m_JSON_Values.Companion_JSON_.Default()))
		_ = _19_valueOrError11
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.OnePositiveTest(name, _dafny.SeqOfString("negative-decrypt"), (_2_description).Dtor_value().(_dafny.Sequence), (_3_config).Dtor_value().(m_JSON_Values.JSON), _4_decryptConfig, (_5_record).Dtor_value().(m_JSON_Values.JSON))
		_19_valueOrError11 = _out1
		if (_19_valueOrError11).IsFailure() {
			output = (_19_valueOrError11).PropagateFailure()
			return output
		}
		var _20_x _dafny.Tuple
		_ = _20_x
		_20_x = (_19_valueOrError11).Extract().(_dafny.Tuple)
		output = m_Wrappers.Companion_Result_.Create_Success_(m_Wrappers.Companion_Option_.Create_Some_(_20_x))
		return output
	} else if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("negative-encrypt")) {
		var _21___v1 m_Wrappers.Result
		_ = _21___v1
		var _out2 m_Wrappers.Result
		_ = _out2
		_out2 = Companion_Default___.OneNegativeTest(name, (_3_config).Dtor_value().(m_JSON_Values.JSON), (_5_record).Dtor_value().(m_JSON_Values.JSON))
		_21___v1 = _out2
...
func (_static *CompanionStruct_Default___) Encrypt(inFile _dafny.Sequence, outFile _dafny.Sequence, lang _dafny.Sequence, version _dafny.Sequence) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
	_ = output
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(135,21): " + (_0_valueOrError0).String())
	}
	var _1_timeStamp _dafny.Sequence
	_ = _1_timeStamp
	_1_timeStamp = (_0_valueOrError0).Extract().(_dafny.Sequence)
	_dafny.Print((_dafny.Companion_Sequence_.Concatenate(_1_timeStamp, _dafny.SeqOfString(" Encrypt : "))).SetString())
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(137,20): " + (_2_valueOrError1).String())
	}
	var _3_configBv _dafny.Sequence
	_ = _3_configBv
	_3_configBv = (_2_valueOrError1).Extract().(_dafny.Sequence)
	var _4_configBytes _dafny.Sequence
	_ = _4_configBytes
	_4_configBytes = m_JSONHelpers.Companion_Default___.BvToBytes(_3_configBv)
	var _5_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _5_valueOrError2
	var _out2 m_Wrappers.Result
	_ = _out2
	...
	if !(!((_5_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(139,17): " + (_5_valueOrError2).String())
	}
	_1_timeStamp = (_5_valueOrError2).Extract().(_dafny.Sequence)
	_dafny.Print((_dafny.Companion_Sequence_.Concatenate(_1_timeStamp, _dafny.SeqOfString(" File Read.\n"))).SetString())
	var _6_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _6_valueOrError3
	_6_valueOrError3 = m_JSON_API.Companion_Default___.Deserialize(_4_configBytes)
	if !(!((_6_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(141,16): " + (_6_valueOrError3).String())
	}
	var _7_json m_JSON_Values.JSON
	_ = _7_json
	_7_json = (_6_valueOrError3).Extract().(m_JSON_Values.JSON)
	...
	if !(!((_8_valueOrError4).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(142,17): " + (_8_valueOrError4).String())
	}
	_1_timeStamp = (_8_valueOrError4).Extract().(_dafny.Sequence)
	_dafny.Print((_dafny.Companion_Sequence_.Concatenate(_1_timeStamp, _dafny.SeqOfString(" JSON Parsed.\n"))).SetString())
	var _9_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _9_valueOrError5
	_9_valueOrError5 = m_Wrappers.Companion_Default___.Need((_7_json).Is_Object(), _dafny.SeqOfString("Encrypt file must contain a JSON object."))
	if (_9_valueOrError5).IsFailure() {
		output = (_9_valueOrError5).PropagateFailure()
		return output
	}
	var _10_keys m_Wrappers.Option
	_ = _10_keys
	_10_keys = m_Wrappers.Companion_Option_.Create_None_()
	...
	var _hi0 _dafny.Int = _dafny.IntOfUint32(((_7_json).Dtor_obj()).Cardinality())
	_ = _hi0
	for _13_i := _dafny.Zero; _13_i.Cmp(_hi0) < 0; _13_i = _13_i.Plus(_dafny.One) {
		var _14_obj _dafny.Tuple
		_ = _14_obj
		_14_obj = ((_7_json).Dtor_obj()).Select((_13_i).Uint32()).(_dafny.Tuple)
		...
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("keys")) {
					...
					_10_keys = m_Wrappers.Companion_Option_.Create_Some_(((*(_14_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("manifest")) {
					...
					_ = _16_valueOrError7
					_16_valueOrError7 = m_Wrappers.Companion_Default___.Need(((*(_14_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'manifest' must be an object."))
			...
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("tests")) {
					...
					_ = _17_valueOrError8
					_17_valueOrError8 = m_Wrappers.Companion_Default___.Need(((*(_14_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'tests' must be an object."))
	...
	_ = _18_valueOrError9
	_18_valueOrError9 = m_Wrappers.Companion_Default___.Need((_10_keys).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'keys' member."))
	...
	_19_valueOrError10 = m_Wrappers.Companion_Default___.Need((_11_manifest).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'manifest' member."))
	...
	_20_valueOrError11 = m_Wrappers.Companion_Default___.Need((_12_tests).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'tests' member."))
	...
	_ = _hi1
	for _21_i := _dafny.Zero; _21_i.Cmp(_hi1) < 0; _21_i = _21_i.Plus(_dafny.One) {
		var _22_obj _dafny.Tuple
		_ = _22_obj
		_22_obj = ((_11_manifest).Dtor_value().(_dafny.Sequence)).Select((_21_i).Uint32()).(_dafny.Tuple)
		var _source1 _dafny.Sequence = (*(_22_obj).IndexInt(0)).(_dafny.Sequence)
		_ = _source1
		{
			{
				if (_source1).Equals(_dafny.SeqOfString("type")) {
					var _23_valueOrError12 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _23_valueOrError12
					_23_valueOrError12 = m_Wrappers.Companion_Default___.Need(((*(_22_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'type' must be a string."))
					if (_23_valueOrError12).IsFailure() {
						output = (_23_valueOrError12).PropagateFailure()
						return output
					}
					var _24_valueOrError13 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _24_valueOrError13
					_24_valueOrError13 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(((*(_22_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str(), m_WriteManifest.Companion_Default___.ENCRYPT__TYPE()), _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Value of 'type' must be '"), m_WriteManifest.Companion_Default___.ENCRYPT__TYPE()), _dafny.SeqOfString("'.")))
					if (_24_valueOrError13).IsFailure() {
						output = (_24_valueOrError13).PropagateFailure()
						return output
					}
					goto Lmatch1
				}
			}
			{
				if (_source1).Equals(_dafny.SeqOfString("version")) {
					...
					_25_valueOrError14 = m_Wrappers.Companion_Default___.Need(((*(_22_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'version' must be a string."))
					...
					_26_valueOrError15 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(((*(_22_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str(), _dafny.SeqOfString("1")), _dafny.SeqOfString("Value of 'version' must be '1'"))
			...
			{
				output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unknown manifest member : "), (*(_22_obj).IndexInt(0)).(_dafny.Sequence)))
				return output
			}
			goto Lmatch1
		}
	...
	var _27_result _dafny.Sequence
	_ = _27_result
	_27_result = _dafny.SeqOf(Companion_Default___.Manifest(), Companion_Default___.Client(lang, version), _dafny.TupleOf(_dafny.SeqOfString("keys"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("file://keys.json"))))
	var _28_test _dafny.Sequence
	_ = _28_test
	_28_test = _dafny.SeqOf()
	var _hi2 _dafny.Int = _dafny.IntOfUint32(((_12_tests).Dtor_value().(_dafny.Sequence)).Cardinality())
	_ = _hi2
	for _29_i := _dafny.Zero; _29_i.Cmp(_hi2) < 0; _29_i = _29_i.Plus(_dafny.One) {
		var _30_obj _dafny.Tuple
		_ = _30_obj
		_30_obj = ((_12_tests).Dtor_value().(_dafny.Sequence)).Select((_29_i).Uint32()).(_dafny.Tuple)
		var _31_valueOrError16 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
		_ = _31_valueOrError16
		_31_valueOrError16 = m_Wrappers.Companion_Default___.Need(((*(_30_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Value of test '"), (*(_30_obj).IndexInt(0)).(_dafny.Sequence)), _dafny.SeqOfString("' must be an Object.")))
		if (_31_valueOrError16).IsFailure() {
			output = (_31_valueOrError16).PropagateFailure()
			return output
		}
		var _32_valueOrError17 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_Wrappers.Companion_Option_.Default())
		_ = _32_valueOrError17
		var _out4 m_Wrappers.Result
		_ = _out4
		_out4 = Companion_Default___.OneTest((*(_30_obj).IndexInt(0)).(_dafny.Sequence), (*(_30_obj).IndexInt(1)).(m_JSON_Values.JSON))
		_32_valueOrError17 = _out4
		if (_32_valueOrError17).IsFailure() {
			output = (_32_valueOrError17).PropagateFailure()
			return output
		}
		var _33_newTest m_Wrappers.Option
		_ = _33_newTest
		_33_newTest = (_32_valueOrError17).Extract().(m_Wrappers.Option)
		if (_33_newTest).Is_Some() {
			_28_test = _dafny.Companion_Sequence_.Concatenate(_28_test, _dafny.SeqOf((_33_newTest).Dtor_value().(_dafny.Tuple)))
		}
	}
	var _34_final m_JSON_Values.JSON
	_ = _34_final
	_34_final = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.Companion_Sequence_.Concatenate(_27_result, _dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("tests"), m_JSON_Values.Companion_JSON_.Create_Object_(_28_test)))))
	var _35_valueOrError18 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _35_valueOrError18
	_35_valueOrError18 = m_JSON_API.Companion_Default___.Serialize(_34_final)
	if !(!((_35_valueOrError18).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(197,21): " + (_35_valueOrError18).String())
	}
	var _36_jsonBytes _dafny.Sequence
	_ = _36_jsonBytes
	_36_jsonBytes = (_35_valueOrError18).Extract().(_dafny.Sequence)
	var _37_jsonBv _dafny.Sequence
	_ = _37_jsonBv
	_37_jsonBv = m_JSONHelpers.Companion_Default___.BytesBv(_36_jsonBytes)
	var _38_valueOrError19 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _38_valueOrError19
	var _out5 m_Wrappers.Result
	_ = _out5
	_out5 = m_FileIO.Companion_Default___.WriteBytesToFile(outFile, _37_jsonBv)
	_38_valueOrError19 = _out5
	if !(!((_38_valueOrError19).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(199,13): " + (_38_valueOrError19).String())
	}
	var _39_x _dafny.Tuple
	_ = _39_x
	_39_x = (_38_valueOrError19).Extract().(_dafny.Tuple)
	var _40_valueOrError20 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _40_valueOrError20
	var _out6 m_Wrappers.Result
	_ = _out6
	_out6 = m__Time.GetCurrentTimeStamp()
	_40_valueOrError20 = _out6
	if !(!((_40_valueOrError20).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(201,17): " + (_40_valueOrError20).String())
	}
	_1_timeStamp = (_40_valueOrError20).Extract().(_dafny.Sequence)
