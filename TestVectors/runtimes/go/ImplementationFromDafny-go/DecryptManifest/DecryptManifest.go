...
func (_static *CompanionStruct_Default___) OnePositiveTest(name _dafny.Sequence, config m_JSON_Values.JSON, encrypted m_JSON_Values.JSON, plaintext m_JSON_Values.JSON) m_Wrappers.Result {
	...
	_ = _out2
	_out2 = m_JsonConfig.Companion_Default___.GetItemEncryptor(name, config)
	...
	_ = _5_encryptor
	_5_encryptor = (_4_valueOrError2).Extract().(*m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient)
	...
	if !(!((_6_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(29,21): " + (_6_valueOrError3).String())
	}
	...
	if !((m_DdbItemJson.Companion_Default___.NormalizeItem((_7_decrypted).Dtor_plaintextItem())).Equals(m_DdbItemJson.Companion_Default___.NormalizeItem((_3_plain).Dtor_item()))) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(34,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	output = m_Wrappers.Companion_Result_.Create_Success_(true)
	return output
	return output
}
func (_static *CompanionStruct_Default___) OneNegativeTest(name _dafny.Sequence, config m_JSON_Values.JSON, encrypted m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
	_ = output
	var _0_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JsonConfig.Companion_Record_.Default())
	_ = _0_valueOrError0
...
func (_static *CompanionStruct_Default___) OneTest(name _dafny.Sequence, value m_JSON_Values.JSON) m_Wrappers.Result {
	...
	if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("positive-decrypt")) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.OnePositiveTest(name, (_3_config).Dtor_value().(m_JSON_Values.JSON), (_4_encrypted).Dtor_value().(m_JSON_Values.JSON), (_5_plaintext).Dtor_value().(m_JSON_Values.JSON))
		output = _out0
	} else if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("negative-decrypt")) {
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.OneNegativeTest(name, (_3_config).Dtor_value().(m_JSON_Values.JSON), (_4_encrypted).Dtor_value().(m_JSON_Values.JSON))
		output = _out1
	} else {
...
func (_static *CompanionStruct_Default___) Decrypt(inFile _dafny.Sequence) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
	_ = output
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(102,21): " + (_0_valueOrError0).String())
	}
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(104,20): " + (_2_valueOrError1).String())
	}
	...
	if !(!((_5_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(106,17): " + (_5_valueOrError2).String())
	}
	...
	if !(!((_6_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(108,16): " + (_6_valueOrError3).String())
	}
	...
	if !(!((_8_valueOrError4).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(109,17): " + (_8_valueOrError4).String())
	}
	...
	_ = _9_valueOrError5
	_9_valueOrError5 = m_Wrappers.Companion_Default___.Need((_7_json).Is_Object(), _dafny.SeqOfString("Decrypt file must contain a JSON object."))
	...
	var _11_client m_Wrappers.Option
	_ = _11_client
	_11_client = m_Wrappers.Companion_Option_.Create_None_()
	var _12_manifest m_Wrappers.Option
	_ = _12_manifest
	_12_manifest = m_Wrappers.Companion_Option_.Create_None_()
	var _13_tests m_Wrappers.Option
	_ = _13_tests
	_13_tests = m_Wrappers.Companion_Option_.Create_None_()
	var _hi0 _dafny.Int = _dafny.IntOfUint32(((_7_json).Dtor_obj()).Cardinality())
	_ = _hi0
	for _14_i := _dafny.Zero; _14_i.Cmp(_hi0) < 0; _14_i = _14_i.Plus(_dafny.One) {
		var _15_obj _dafny.Tuple
		_ = _15_obj
		_15_obj = ((_7_json).Dtor_obj()).Select((_14_i).Uint32()).(_dafny.Tuple)
		var _source0 _dafny.Sequence = (*(_15_obj).IndexInt(0)).(_dafny.Sequence)
		_ = _source0
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("keys")) {
					...
					_ = _16_valueOrError6
					_16_valueOrError6 = m_Wrappers.Companion_Default___.Need(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'keys' must be a string."))
					if (_16_valueOrError6).IsFailure() {
						output = (_16_valueOrError6).PropagateFailure()
						return output
					}
					_10_keys = m_Wrappers.Companion_Option_.Create_Some_(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("client")) {
					...
					_ = _17_valueOrError7
					_17_valueOrError7 = m_Wrappers.Companion_Default___.Need(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'client' must be an Object."))
					if (_17_valueOrError7).IsFailure() {
						output = (_17_valueOrError7).PropagateFailure()
						return output
					}
					_11_client = m_Wrappers.Companion_Option_.Create_Some_(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_obj())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("manifest")) {
					var _18_valueOrError8 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _18_valueOrError8
					_18_valueOrError8 = m_Wrappers.Companion_Default___.Need(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'manifest' must be an object."))
					if (_18_valueOrError8).IsFailure() {
						output = (_18_valueOrError8).PropagateFailure()
						return output
					}
					_12_manifest = m_Wrappers.Companion_Option_.Create_Some_(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_obj())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("tests")) {
					var _19_valueOrError9 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _19_valueOrError9
					_19_valueOrError9 = m_Wrappers.Companion_Default___.Need(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'tests' must be an object."))
					if (_19_valueOrError9).IsFailure() {
						output = (_19_valueOrError9).PropagateFailure()
						return output
					}
					_13_tests = m_Wrappers.Companion_Option_.Create_Some_(((*(_15_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_obj())
					goto Lmatch0
				}
			}
			{
				output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unknown top level encrypt tag : "), (*(_15_obj).IndexInt(0)).(_dafny.Sequence)))
				return output
			}
			goto Lmatch0
		}
	...
	var _20_valueOrError10 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _20_valueOrError10
	_20_valueOrError10 = m_Wrappers.Companion_Default___.Need((_10_keys).Is_Some(), _dafny.SeqOfString("Decrypt manifest requires a 'keys' member."))
	if (_20_valueOrError10).IsFailure() {
		output = (_20_valueOrError10).PropagateFailure()
		return output
	}
	var _21_valueOrError11 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _21_valueOrError11
	_21_valueOrError11 = m_Wrappers.Companion_Default___.Need((_11_client).Is_Some(), _dafny.SeqOfString("Decrypt manifest requires a 'client' member."))
	if (_21_valueOrError11).IsFailure() {
		output = (_21_valueOrError11).PropagateFailure()
		return output
	}
	var _22_valueOrError12 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _22_valueOrError12
	_22_valueOrError12 = m_Wrappers.Companion_Default___.Need((_12_manifest).Is_Some(), _dafny.SeqOfString("Decrypt manifest requires a 'manifest' member."))
	if (_22_valueOrError12).IsFailure() {
		output = (_22_valueOrError12).PropagateFailure()
		return output
	}
	var _23_valueOrError13 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _23_valueOrError13
	_23_valueOrError13 = m_Wrappers.Companion_Default___.Need((_13_tests).Is_Some(), _dafny.SeqOfString("Decrypt manifest requires a 'tests' member."))
	if (_23_valueOrError13).IsFailure() {
		output = (_23_valueOrError13).PropagateFailure()
		return output
	}
	var _hi1 _dafny.Int = _dafny.IntOfUint32(((_12_manifest).Dtor_value().(_dafny.Sequence)).Cardinality())
	_ = _hi1
	for _24_i := _dafny.Zero; _24_i.Cmp(_hi1) < 0; _24_i = _24_i.Plus(_dafny.One) {
		var _25_obj _dafny.Tuple
		_ = _25_obj
		_25_obj = ((_12_manifest).Dtor_value().(_dafny.Sequence)).Select((_24_i).Uint32()).(_dafny.Tuple)
		var _source1 _dafny.Sequence = (*(_25_obj).IndexInt(0)).(_dafny.Sequence)
		_ = _source1
		{
			{
				if (_source1).Equals(_dafny.SeqOfString("type")) {
					var _26_valueOrError14 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _26_valueOrError14
					_26_valueOrError14 = m_Wrappers.Companion_Default___.Need(((*(_25_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'type' must be a string."))
					if (_26_valueOrError14).IsFailure() {
						output = (_26_valueOrError14).PropagateFailure()
						return output
					}
					var _27_valueOrError15 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _27_valueOrError15
					_27_valueOrError15 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(((*(_25_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str(), m_WriteManifest.Companion_Default___.DECRYPT__TYPE()), _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Value of 'type' must be '"), m_WriteManifest.Companion_Default___.DECRYPT__TYPE()), _dafny.SeqOfString("'.")))
					if (_27_valueOrError15).IsFailure() {
						output = (_27_valueOrError15).PropagateFailure()
						return output
					}
					goto Lmatch1
				}
			}
			{
				if (_source1).Equals(_dafny.SeqOfString("version")) {
					var _28_valueOrError16 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _28_valueOrError16
					_28_valueOrError16 = m_Wrappers.Companion_Default___.Need(((*(_25_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'version' must be a string."))
					if (_28_valueOrError16).IsFailure() {
						output = (_28_valueOrError16).PropagateFailure()
						return output
					}
					var _29_valueOrError17 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _29_valueOrError17
					_29_valueOrError17 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(((*(_25_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str(), _dafny.SeqOfString("1")), _dafny.SeqOfString("Value of 'version' must be '1'"))
					if (_29_valueOrError17).IsFailure() {
						output = (_29_valueOrError17).PropagateFailure()
						return output
					}
					goto Lmatch1
				}
			...
			{
				output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unknown manifest member : "), (*(_25_obj).IndexInt(0)).(_dafny.Sequence)))
				return output
			}
			goto Lmatch1
		}
	...
	var _hi2 _dafny.Int = _dafny.IntOfUint32(((_13_tests).Dtor_value().(_dafny.Sequence)).Cardinality())
	_ = _hi2
	for _30_i := _dafny.Zero; _30_i.Cmp(_hi2) < 0; _30_i = _30_i.Plus(_dafny.One) {
		var _31_obj _dafny.Tuple
		_ = _31_obj
		_31_obj = ((_13_tests).Dtor_value().(_dafny.Sequence)).Select((_30_i).Uint32()).(_dafny.Tuple)
		...
		_ = _out4
		_out4 = Companion_Default___.OneTest((*(_31_obj).IndexInt(0)).(_dafny.Sequence), (*(_31_obj).IndexInt(1)).(m_JSON_Values.JSON))
		_33_valueOrError19 = _out4
	...
	_ = _out5
	_out5 = m__Time.GetCurrentTimeStamp()
	_35_valueOrError20 = _out5
	if !(!((_35_valueOrError20).IsFailure())) {
		panic("dafny/DDBEncryption/src/DecryptManifest.dfy(160,17): " + (_35_valueOrError20).String())
	}
