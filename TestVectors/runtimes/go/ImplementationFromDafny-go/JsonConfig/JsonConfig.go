...
func (_static *CompanionStruct_Default___) GetRoundTripTests(data m_JSON_Values.JSON) m_Wrappers.Result {
		...
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("Configs")) {
					...
					var _out0 m_Wrappers.Result
					_ = _out0
					_out0 = Companion_Default___.GetTableConfigs((*(_4_obj).IndexInt(1)).(m_JSON_Values.JSON))
...
func (_static *CompanionStruct_Default___) GetWriteTests(data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.GetOneWriteTest(_3_obj)
...
func (_static *CompanionStruct_Default___) GetOneWriteTest(data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
		...
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("Config")) {
					...
					var _out0 m_Wrappers.Result
					_ = _out0
					_out0 = Companion_Default___.GetOneTableConfig(_dafny.SeqOfString("foo"), (*(_5_obj).IndexInt(1)).(m_JSON_Values.JSON))
...
func (_static *CompanionStruct_Default___) GetDecryptTests(data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.GetOneDecryptTest(_3_obj)
		_4_valueOrError1 = _out0
		if (_4_valueOrError1).IsFailure() {
			output = (_4_valueOrError1).PropagateFailure()
			return output
...
func (_static *CompanionStruct_Default___) GetOneDecryptTest(data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
...
func (_static *CompanionStruct_Default___) GetTableConfigs(data m_JSON_Values.JSON) m_Wrappers.Result {
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.GetOneTableConfig((*(_3_obj).IndexInt(0)).(_dafny.Sequence), (*(_3_obj).IndexInt(1)).(m_JSON_Values.JSON))
		_4_valueOrError1 = _out0
		if (_4_valueOrError1).IsFailure() {
			output = (_4_valueOrError1).PropagateFailure()
			return output
...
func (_static *CompanionStruct_Default___) GetItemEncryptor(name _dafny.Sequence, data m_JSON_Values.JSON) m_Wrappers.Result {
		...
		_ = _source0
		{
			...
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("key")) {
					...
					_ = _23_valueOrError6
					_23_valueOrError6 = (m_JSON_API.Companion_Default___.Serialize((*(_17_obj).IndexInt(1)).(m_JSON_Values.JSON))).MapFailure(func(coer26 func(m_JSON_Errors.SerializationError) _dafny.Sequence) func(interface{}) interface{} {
						return func(arg34 interface{}) interface{} {
							return coer26(arg34.(m_JSON_Errors.SerializationError))
						}
	...
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = m_KeyVectors.Companion_Default___.KeyVectors(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyVectorsConfig_.Create_KeyVectorsConfig_(Companion_Default___.DEFAULT__KEYS()))
	_30_valueOrError12 = _out2
	if !(!((_30_valueOrError12).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(299,16): " + (_30_valueOrError12).String())
	}
	var _31_keys *m_KeyVectors.KeyVectorsClient
	_ = _31_keys
	_31_keys = (_30_valueOrError12).Extract().(*m_KeyVectors.KeyVectorsClient)
	var _32_valueOrError14 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Default())
	_ = _32_valueOrError14
	if (_dafny.IntOfUint32((_9_key).Cardinality())).Sign() == 0 {
		_32_valueOrError14 = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_Hierarchy_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_HierarchyKeyring_.Create_HierarchyKeyring_(_dafny.SeqOfString("static-branch-key-1"))))
	} else {
		var _33_valueOrError13 m_Wrappers.Result = ((_31_keys).GetKeyDescription(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_GetKeyDescriptionInput_.Create_GetKeyDescriptionInput_(_9_key))).MapFailure(func(coer27 func(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg35 interface{}) interface{} {
				return coer27(arg35.(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error))
			}
		}(m_ParseJsonManifests.Companion_Default___.ErrorToString))
		_ = _33_valueOrError13
		if (_33_valueOrError13).IsFailure() {
			_32_valueOrError14 = (_33_valueOrError13).PropagateFailure()
		} else {
			var _34_keyOut m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionOutput = (_33_valueOrError13).Extract().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionOutput)
			_ = _34_keyOut
			_32_valueOrError14 = m_Wrappers.Companion_Result_.Create_Success_((_34_keyOut).Dtor_keyDescription())
		}
	}
	if (_32_valueOrError14).IsFailure() {
		encryptor = (_32_valueOrError14).PropagateFailure()
		return encryptor
	}
	var _35_keyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
	_ = _35_keyDescription
	_35_keyDescription = (_32_valueOrError14).Extract().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
	var _36_valueOrError15 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _36_valueOrError15
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_31_keys).CreateWrappedTestVectorKeyring(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_TestVectorKeyringInput_.Create_TestVectorKeyringInput_(_35_keyDescription))
	_36_valueOrError15 = _out3
	if !(!((_36_valueOrError15).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(314,19): " + (_36_valueOrError15).String())
	}
	var _37_keyring m_AwsCryptographyMaterialProvidersTypes.IKeyring
	_ = _37_keyring
	_37_keyring = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.CastTo_((_36_valueOrError15).Extract())
	var _38_encryptorConfig m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DynamoDbItemEncryptorConfig
	_ = _38_encryptorConfig
	_38_encryptorConfig = m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_DynamoDbItemEncryptorConfig_.Create_DynamoDbItemEncryptorConfig_(_1_logicalTableName, _2_partitionKeyName, _3_sortKeyName, _6_attributeActionsOnEncrypt, Companion_Default___.OptSeq(_7_allowed), Companion_Default___.OptSeq(_8_prefix), _4_algorithmSuiteId, m_Wrappers.Companion_Option_.Create_Some_(_37_keyring), m_Wrappers.Companion_Option_.Create_None_(), _14_legacyOverride, _15_plaintextOverride)
	var _39_valueOrError16 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _39_valueOrError16
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = m_DynamoDbItemEncryptor.Companion_Default___.DynamoDbItemEncryptor(_38_encryptorConfig)
	_39_valueOrError16 = _out4
	if !(!((_39_valueOrError16).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(330,50): " + (_39_valueOrError16).String())
	}
	var _40_enc m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.IDynamoDbItemEncryptorClient
	_ = _40_enc
	_40_enc = (_39_valueOrError16).Extract().(*m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient)
	var _41_encr *m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient
	_ = _41_encr
	_41_encr = _40_enc.(*m_DynamoDbItemEncryptor.DynamoDbItemEncryptorClient)
	encryptor = m_Wrappers.Companion_Result_.Create_Success_(_41_encr)
	return encryptor
	return encryptor
}
func (_static *CompanionStruct_Default___) GetOneTableConfig(name _dafny.Sequence, data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
		...
		_ = _source0
		{
			...
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("key")) {
					...
					_ = _24_valueOrError6
					_24_valueOrError6 = (m_JSON_API.Companion_Default___.Serialize((*(_18_obj).IndexInt(1)).(m_JSON_Values.JSON))).MapFailure(func(coer28 func(m_JSON_Errors.SerializationError) _dafny.Sequence) func(interface{}) interface{} {
						return func(arg36 interface{}) interface{} {
							return coer28(arg36.(m_JSON_Errors.SerializationError))
						}
	...
	var _33_valueOrError13 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _33_valueOrError13
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = m_KeyVectors.Companion_Default___.KeyVectors(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyVectorsConfig_.Create_KeyVectorsConfig_(Companion_Default___.DEFAULT__KEYS()))
	_33_valueOrError13 = _out3
	if !(!((_33_valueOrError13).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(403,16): " + (_33_valueOrError13).String())
	}
	var _34_keys *m_KeyVectors.KeyVectorsClient
	_ = _34_keys
	_34_keys = (_33_valueOrError13).Extract().(*m_KeyVectors.KeyVectorsClient)
	var _35_valueOrError15 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Default())
	_ = _35_valueOrError15
	if (_dafny.IntOfUint32((_9_key).Cardinality())).Sign() == 0 {
		_35_valueOrError15 = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_Hierarchy_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_HierarchyKeyring_.Create_HierarchyKeyring_(_dafny.SeqOfString("static-branch-key-1"))))
	} else {
		var _36_valueOrError14 m_Wrappers.Result = ((_34_keys).GetKeyDescription(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_GetKeyDescriptionInput_.Create_GetKeyDescriptionInput_(_9_key))).MapFailure(func(coer29 func(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg37 interface{}) interface{} {
				return coer29(arg37.(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error))
			}
		}(m_ParseJsonManifests.Companion_Default___.ErrorToString))
		_ = _36_valueOrError14
		if (_36_valueOrError14).IsFailure() {
			_35_valueOrError15 = (_36_valueOrError14).PropagateFailure()
		} else {
			var _37_keyOut m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionOutput = (_36_valueOrError14).Extract().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionOutput)
			_ = _37_keyOut
			_35_valueOrError15 = m_Wrappers.Companion_Result_.Create_Success_((_37_keyOut).Dtor_keyDescription())
		}
	}
	if (_35_valueOrError15).IsFailure() {
		output = (_35_valueOrError15).PropagateFailure()
		return output
	}
	var _38_keyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
	_ = _38_keyDescription
	_38_keyDescription = (_35_valueOrError15).Extract().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
	var _39_valueOrError16 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _39_valueOrError16
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = (_34_keys).CreateWrappedTestVectorKeyring(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_TestVectorKeyringInput_.Create_TestVectorKeyringInput_(_38_keyDescription))
	_39_valueOrError16 = _out4
	if !(!((_39_valueOrError16).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(418,19): " + (_39_valueOrError16).String())
	}
	var _40_keyring m_AwsCryptographyMaterialProvidersTypes.IKeyring
	_ = _40_keyring
	_40_keyring = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.CastTo_((_39_valueOrError16).Extract())
	var _41_config m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTableEncryptionConfig
	_ = _41_config
	_41_config = m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_DynamoDbTableEncryptionConfig_.Create_DynamoDbTableEncryptionConfig_(_1_logicalTableName, _2_partitionKeyName, _3_sortKeyName, _14_search, _6_attributeActionsOnEncrypt, Companion_Default___.OptSeq(_7_allowed), Companion_Default___.OptSeq(_8_prefix), _4_algorithmSuiteId, m_Wrappers.Companion_Option_.Create_Some_(_40_keyring), m_Wrappers.Companion_Option_.Create_None_(), _15_legacyOverride, _16_plaintextOverride)
	output = m_Wrappers.Companion_Result_.Create_Success_(Companion_TableConfig_.Create_TableConfig_(name, _41_config, (_dafny.IntOfUint32(((data).Dtor_obj()).Cardinality())).Sign() == 0))
	return output
	return output
}
...
func (_static *CompanionStruct_Default___) GetOneBeaconVersion(data m_JSON_Values.JSON) m_Wrappers.Result {
	...
	_ = _13_keyMaterial
	_13_keyMaterial = m_KeyMaterial.Companion_KeyMaterial_.Create_StaticKeyStoreInformation_(_dafny.SeqOfString("abc"), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("abc")), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5)), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5)))
	...
	if (_4_keySource).Is_Some() {
		...
		_15_source = m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_BeaconKeySource_.Create_single_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_SingleKeyStore_.Create_SingleKeyStore_(_dafny.SeqOfString("foo"), int32(42)))
	}
...
func (_static *CompanionStruct_Default___) GetFakeBeaconVersion() m_Wrappers.Result {
	...
	_ = _0_keyMaterial
	_0_keyMaterial = m_KeyMaterial.Companion_KeyMaterial_.Create_StaticKeyStoreInformation_(_dafny.SeqOfString("abc"), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("abc")), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5)), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5)))
	...
	_ = _2_source
	_2_source = m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_BeaconKeySource_.Create_single_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_SingleKeyStore_.Create_SingleKeyStore_(_dafny.SeqOfString("foo"), int32(42)))
	...
	if !(!((_4_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(517,15): " + (_4_valueOrError0).String())
	}
	...
	if !(!((_8_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(524,17): " + (_8_valueOrError1).String())
	}
	...
	if !(!((_10_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(526,18): " + (_10_valueOrError2).String())
	}
	...
	_ = _12_src
	_12_src = m_SearchableEncryptionInfo.Companion_KeySource_.Create_KeySource_(_11_client, _1_store, m_SearchableEncryptionInfo.Companion_KeyLocation_.Create_SingleLoc_(_dafny.SeqOfString("foo")), _9_cache, uint32(100))
	var _13_valueOrError3 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _13_valueOrError3
	_13_valueOrError3 = m_SearchableEncryptionInfo.Companion_Default___.MakeBeaconVersion(uint8(1), _12_src, _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap())
	if !(!((_13_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/JsonConfig.dfy(529,14): " + (_13_valueOrError3).String())
	}
	var _14_bv m_SearchableEncryptionInfo.BeaconVersion
	_ = _14_bv
	_14_bv = (_13_valueOrError3).Extract().(m_SearchableEncryptionInfo.BeaconVersion)
	output = m_Wrappers.Companion_Result_.Create_Success_(_14_bv)
	return output
	return output
}
...
func (_static *CompanionStruct_Default___) GetKeySource(data m_JSON_Values.JSON) m_Wrappers.Result {
	...
	if (_dafny.IntOfUint32((_2_keyId).Cardinality())).Sign() == 1 {
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_BeaconKeySource_.Create_single_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_SingleKeyStore_.Create_SingleKeyStore_(_2_keyId, (_3_cacheTTL).Int32())))
		return output
	} else {
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_BeaconKeySource_.Create_multi_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_MultiKeyStore_.Create_MultiKeyStore_(_1_keyFieldName, (_3_cacheTTL).Int32(), m_Wrappers.Companion_Option_.Create_None_())))
		return output
	}
	return output
}
...
func (_static *CompanionStruct_Default___) GetIoTests(data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.GetOneIoTest((*(_3_obj).IndexInt(0)).(_dafny.Sequence), (*(_3_obj).IndexInt(1)).(m_JSON_Values.JSON))
		_4_valueOrError1 = _out0
		if (_4_valueOrError1).IsFailure() {
			output = (_4_valueOrError1).PropagateFailure()
			return output
...
func (_static *CompanionStruct_Default___) GetOneIoTest(name _dafny.Sequence, data m_JSON_Values.JSON) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _0_valueOrError0
		...
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("WriteConfig")) {
					...
					var _out0 m_Wrappers.Result
					_ = _out0
					_out0 = Companion_Default___.GetOneTableConfig((*(_8_obj).IndexInt(0)).(_dafny.Sequence), (*(_8_obj).IndexInt(1)).(m_JSON_Values.JSON))
			...
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("ReadConfig")) {
					...
					var _out1 m_Wrappers.Result
					_ = _out1
					_out1 = Companion_Default___.GetOneTableConfig((*(_8_obj).IndexInt(0)).(_dafny.Sequence), (*(_8_obj).IndexInt(1)).(m_JSON_Values.JSON))
...
func (_static *CompanionStruct_Default___) DEFAULT__KEYS() _dafny.Sequence {
	return _dafny.SeqOfString("../../../submodules/MaterialProviders/TestVectorsAwsCryptographicMaterialProviders/dafny/TestVectorsAwsCryptographicMaterialProviders/test/keys.json")
}
