...
// Dafny module Permutations compiled into Go
...
func (_static *CompanionStruct_Default___) GeneratePermutations(source _dafny.Sequence) _dafny.Sequence {
	var result _dafny.Sequence = _dafny.EmptySeq
	_ = result
	if (_dafny.IntOfUint32((source).Cardinality())).Sign() == 0 {
		result = _dafny.SeqOf()
		return result
	}
	if (_dafny.IntOfUint32((source).Cardinality())).Cmp(_dafny.One) == 0 {
		result = _dafny.SeqOf(source)
		return result
	}
	var _0_A _dafny.Array
	_ = _0_A
	var _len0_0 _dafny.Int = _dafny.IntOfUint32((source).Cardinality())
	_ = _len0_0
	...
	if _len0_0.Cmp(_dafny.Zero) == 0 {
		...
		var _init0 func(_dafny.Int) interface{} = (func(_1_source _dafny.Sequence) func(_dafny.Int) interface{} {
			return func(_2_i _dafny.Int) interface{} {
				return (_1_source).Select((_2_i).Uint32()).(interface{})
			}
		})(source)
		_ = _init0
	...
	_ = _out0
	_out0 = Companion_Default___.Permute(_dafny.ArrayLen((_0_A), 0), _0_A)
	result = _out0
	return result
}
func (_static *CompanionStruct_Default___) Swap(A _dafny.Array, x _dafny.Int, y _dafny.Int) {
	var _0_tmp interface{}
	_ = _0_tmp
	_0_tmp = (A).ArrayGet1((x).Int())
	(A).ArraySet1((A).ArrayGet1((y).Int()), (x).Int())
	(A).ArraySet1(_0_tmp, (y).Int())
}
func (_static *CompanionStruct_Default___) Permute(k _dafny.Int, A _dafny.Array) _dafny.Sequence {
	var result _dafny.Sequence = _dafny.EmptySeq
	_ = result
	if (k).Cmp(_dafny.One) == 0 {
		result = _dafny.SeqOf(_dafny.ArrayRangeToSeq(A, _dafny.NilInt, _dafny.NilInt))
		return result
	} else {
		var _0_result _dafny.Sequence
		_ = _0_result
		_0_result = _dafny.SeqOf()
		var _hi0 _dafny.Int = k
		_ = _hi0
		for _1_i := _dafny.Zero; _1_i.Cmp(_hi0) < 0; _1_i = _1_i.Plus(_dafny.One) {
			var _2_next _dafny.Sequence
			_ = _2_next
			var _out0 _dafny.Sequence
			_ = _out0
			_out0 = Companion_Default___.Permute((k).Minus(_dafny.One), A)
			_2_next = _out0
			_0_result = _dafny.Companion_Sequence_.Concatenate(_0_result, _2_next)
			if ((k).Modulo(_dafny.One)).Sign() == 0 {
				Companion_Default___.Swap(A, _1_i, (k).Minus(_dafny.One))
			} else {
				Companion_Default___.Swap(A, _dafny.Zero, (k).Minus(_dafny.One))
			}
		}
		result = _0_result
		return result
