// Package WrappedDDBEncryptionMain
// Dafny module WrappedDDBEncryptionMain compiled into Go
...
import (
	...
	m_WriteSetPermutations "github.com/aws/aws-database-encryption-sdk-dynamodb/testvectors/WriteSetPermutations"
...
var _ m_WriteSetPermutations.Dummy__
...
func (*Default__) String() string {
	return "WrappedDDBEncryptionMain.Default__"
}
...
func (_static *CompanionStruct_Default___) AddJson(prev m_DdbEncryptionTestVectors.TestVectorConfig, file _dafny.Sequence) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_configBv m_Wrappers.Result
	_ = _0_configBv
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_FileIO.Companion_Default___.ReadBytesFromFile(file)
	_0_configBv = _out0
	if (_0_configBv).Is_Failure() {
		_dafny.Print((_dafny.SeqOfString("Failed to open ")).SetString())
		_dafny.Print((file).SetString())
		_dafny.Print((_dafny.SeqOfString(" continuing anyway.\n")).SetString())
		output = m_Wrappers.Companion_Result_.Create_Success_(m_DdbEncryptionTestVectors.Companion_Default___.MakeEmptyTestVector())
		return output
	}
	var _1_configBytes _dafny.Sequence
	_ = _1_configBytes
	_1_configBytes = m_JSONHelpers.Companion_Default___.BvToBytes((_0_configBv).Dtor_value().(_dafny.Sequence))
	var _2_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _2_valueOrError0
	_2_valueOrError0 = m_JSON_API.Companion_Default___.Deserialize(_1_configBytes)
	if !(!((_2_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(26,16): " + (_2_valueOrError0).String())
	}
	var _3_json m_JSON_Values.JSON
	_ = _3_json
	_3_json = (_2_valueOrError0).Extract().(m_JSON_Values.JSON)
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_DdbEncryptionTestVectors.Companion_Default___.ParseTestVector(_3_json, prev)
	output = _out1
	if (output).Is_Failure() {
		_dafny.Print(((output).Dtor_error().(_dafny.Sequence)).SetString())
		_dafny.Print((_dafny.SeqOfString("\n")).SetString())
	}
	return output
}
func (_static *CompanionStruct_Default___) ASDF() {
	m_WriteSetPermutations.Companion_Default___.WriteSetPermutations()
	var _0_config m_DdbEncryptionTestVectors.TestVectorConfig
	_ = _0_config
	_0_config = m_DdbEncryptionTestVectors.Companion_Default___.MakeEmptyTestVector()
	var _1_valueOrError0 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _1_valueOrError0
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = Companion_Default___.AddJson(_0_config, _dafny.SeqOfString("records.json"))
	_1_valueOrError0 = _out0
	if !(!((_1_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(36,14): " + (_1_valueOrError0).String())
	}
	_0_config = (_1_valueOrError0).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _2_valueOrError1 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _2_valueOrError1
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = Companion_Default___.AddJson(_0_config, _dafny.SeqOfString("configs.json"))
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(37,14): " + (_2_valueOrError1).String())
	}
	_0_config = (_2_valueOrError1).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _3_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _3_valueOrError2
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = Companion_Default___.AddJson(_0_config, _dafny.SeqOfString("data.json"))
	_3_valueOrError2 = _out2
	if !(!((_3_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(38,14): " + (_3_valueOrError2).String())
	}
	_0_config = (_3_valueOrError2).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _4_valueOrError3 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _4_valueOrError3
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = Companion_Default___.AddJson(_0_config, _dafny.SeqOfString("iotest.json"))
	_4_valueOrError3 = _out3
	if !(!((_4_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(39,14): " + (_4_valueOrError3).String())
	}
	_0_config = (_4_valueOrError3).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _5_valueOrError4 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _5_valueOrError4
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = Companion_Default___.AddJson(_0_config, _dafny.SeqOfString("PermTest.json"))
	_5_valueOrError4 = _out4
	if !(!((_5_valueOrError4).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(40,14): " + (_5_valueOrError4).String())
	}
	_0_config = (_5_valueOrError4).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	(_0_config).RunAllTests()
}
