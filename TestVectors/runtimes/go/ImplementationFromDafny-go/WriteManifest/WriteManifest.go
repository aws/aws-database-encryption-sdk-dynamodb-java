...
func (_static *CompanionStruct_Default___) Write(fileName _dafny.Sequence) m_Wrappers.Result {
	...
	var _20_jsonBv _dafny.Sequence
	_ = _20_jsonBv
	_20_jsonBv = m_JSONHelpers.Companion_Default___.BytesBv(_19_jsonBytes)
	var _21_x m_Wrappers.Result
	_ = _21_x
	var _out15 m_Wrappers.Result
	_ = _out15
	_out15 = m_FileIO.Companion_Default___.WriteBytesToFile(fileName, _20_jsonBv)
	_21_x = _out15
	if !((_21_x).Is_Success()) {
		panic("dafny/DDBEncryption/src/WriteManifest.dfy(406,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
