// Package WriteSetPermutations
// Dafny module WriteSetPermutations compiled into Go
...
import (
	...
	m_DdbEncryptionTestVectors "github.com/aws/aws-database-encryption-sdk-dynamodb/testvectors/DdbEncryptionTestVectors"
	...
	m_Permutations "github.com/aws/aws-database-encryption-sdk-dynamodb/testvectors/Permutations"
...
var _ m_DdbEncryptionTestVectors.Dummy__
var _ m_Permutations.Dummy__
...
func (*Default__) String() string {
	return "WriteSetPermutations.Default__"
}
...
func (_static *CompanionStruct_Default___) EncodeStrings(bytes _dafny.Sequence, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((bytes).Cardinality())).Sign() == 0 {
		return acc
	} else {
		var _in0 _dafny.Sequence = (bytes).Drop(1)
		_ = _in0
		var _in1 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(m_Base64.Companion_Default___.Encode((bytes).Select(0).(_dafny.Sequence))))
		_ = _in1
		bytes = _in0
		acc = _in1
		goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) GetBinaryArray(bytes _dafny.Sequence) m_JSON_Values.JSON {
	var _0_strs _dafny.Sequence = Companion_Default___.EncodeStrings(bytes, _dafny.SeqOf())
	_ = _0_strs
	return Companion_Default___.GetStringArray(_0_strs, _dafny.SeqOf())
}
func (_static *CompanionStruct_Default___) GetRecord(recNum _dafny.Int, str _dafny.Sequence, num _dafny.Sequence, bytes _dafny.Sequence) m_JSON_Values.JSON {
	var _0_numStr _dafny.Sequence = m_StandardLibrary_String.Companion_Default___.Base10Int2String(recNum)
	_ = _0_numStr
	return m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("RecNum"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("N"), m_JSON_Values.Companion_JSON_.Create_String_(_0_numStr))))), _dafny.TupleOf(_dafny.SeqOfString("StringSet"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("SS"), Companion_Default___.GetStringArray(str, _dafny.SeqOf()))))), _dafny.TupleOf(_dafny.SeqOfString("NumberSet"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("NS"), Companion_Default___.GetStringArray(num, _dafny.SeqOf()))))), _dafny.TupleOf(_dafny.SeqOfString("BinarySet"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("BS"), Companion_Default___.GetBinaryArray(bytes)))))))
}
func (_static *CompanionStruct_Default___) GetRecords2(recNum _dafny.Int, str _dafny.Sequence, num _dafny.Sequence, bytes _dafny.Sequence, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (((_dafny.IntOfUint32((str).Cardinality())).Sign() == 0) || ((_dafny.IntOfUint32((num).Cardinality())).Sign() == 0)) || ((_dafny.IntOfUint32((bytes).Cardinality())).Sign() == 0) {
		return acc
	} else {
		var _0_newRec m_JSON_Values.JSON = Companion_Default___.GetRecord(recNum, (str).Select(0).(_dafny.Sequence), (num).Select(0).(_dafny.Sequence), (bytes).Select(0).(_dafny.Sequence))
		_ = _0_newRec
		var _in0 _dafny.Int = (recNum).Plus(_dafny.One)
		_ = _in0
		var _in1 _dafny.Sequence = (str).Drop(1)
		_ = _in1
		var _in2 _dafny.Sequence = (num).Drop(1)
		_ = _in2
		var _in3 _dafny.Sequence = (bytes).Drop(1)
		_ = _in3
		var _in4 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(_0_newRec))
		_ = _in4
		recNum = _in0
		str = _in1
		num = _in2
...
func (_static *CompanionStruct_Default___) GetRecords() _dafny.Sequence {
	var result _dafny.Sequence = _dafny.EmptySeq
	_ = result
	var _0_recs _dafny.Sequence
	_ = _0_recs
	_0_recs = _dafny.SeqOf()
	var _1_recs1 _dafny.Sequence
	_ = _1_recs1
	_1_recs1 = _dafny.SeqOf(Companion_Default___.GetRecord(_dafny.IntOfInt64(200), _dafny.SeqOf(_dafny.SeqOfString("aaa")), _dafny.SeqOf(_dafny.SeqOfString("111")), _dafny.SeqOf(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)))))
	var _2_p2s _dafny.Sequence
	_ = _2_p2s
	var _out0 _dafny.Sequence
	_ = _out0
	_out0 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("aaa"), _dafny.SeqOfString("bbb")))
	_2_p2s = _out0
	var _3_p2n _dafny.Sequence
	_ = _3_p2n
	var _out1 _dafny.Sequence
	_ = _out1
	_out1 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("111"), _dafny.SeqOfString("222")))
	_3_p2n = _out1
	var _4_p2b _dafny.Sequence
	_ = _4_p2b
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)), _dafny.SeqOf(uint8(2), uint8(3), uint8(4))))
	_4_p2b = _out2
	var _5_recs2 _dafny.Sequence
	_ = _5_recs2
	_5_recs2 = Companion_Default___.GetRecords2(_dafny.IntOfInt64(201), _2_p2s, _3_p2n, _4_p2b, _dafny.SeqOf())
	var _6_p3s _dafny.Sequence
	_ = _6_p3s
	var _out3 _dafny.Sequence
	_ = _out3
	_out3 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("aaa"), _dafny.SeqOfString("bbb"), _dafny.SeqOfString("ccc")))
	_6_p3s = _out3
	var _7_p3n _dafny.Sequence
	_ = _7_p3n
	var _out4 _dafny.Sequence
	_ = _out4
	_out4 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("111"), _dafny.SeqOfString("222"), _dafny.SeqOfString("333")))
	_7_p3n = _out4
	var _8_p3b _dafny.Sequence
	_ = _8_p3b
	var _out5 _dafny.Sequence
	_ = _out5
	_out5 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)), _dafny.SeqOf(uint8(2), uint8(3), uint8(4)), _dafny.SeqOf(uint8(3), uint8(4), uint8(5))))
	_8_p3b = _out5
	var _9_recs3 _dafny.Sequence
	_ = _9_recs3
	_9_recs3 = Companion_Default___.GetRecords2(_dafny.IntOfInt64(203), _6_p3s, _7_p3n, _8_p3b, _dafny.SeqOf())
	var _10_p4s _dafny.Sequence
	_ = _10_p4s
	var _out6 _dafny.Sequence
	_ = _out6
	_out6 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("aaa"), _dafny.SeqOfString("bbb"), _dafny.SeqOfString("ccc"), _dafny.SeqOfString("ddd")))
	_10_p4s = _out6
	var _11_p4n _dafny.Sequence
	_ = _11_p4n
	var _out7 _dafny.Sequence
	_ = _out7
	_out7 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOfString("111"), _dafny.SeqOfString("222"), _dafny.SeqOfString("333"), _dafny.SeqOfString("444")))
	_11_p4n = _out7
	var _12_p4b _dafny.Sequence
	_ = _12_p4b
	var _out8 _dafny.Sequence
	_ = _out8
	_out8 = m_Permutations.Companion_Default___.GeneratePermutations(_dafny.SeqOf(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)), _dafny.SeqOf(uint8(2), uint8(3), uint8(4)), _dafny.SeqOf(uint8(3), uint8(4), uint8(5)), _dafny.SeqOf(uint8(4), uint8(5), uint8(6))))
	_12_p4b = _out8
	var _13_recs4 _dafny.Sequence
	_ = _13_recs4
	_13_recs4 = Companion_Default___.GetRecords2(_dafny.IntOfInt64(209), _10_p4s, _11_p4n, _12_p4b, _dafny.SeqOf())
	result = _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_1_recs1, _5_recs2), _9_recs3), _13_recs4)
	return result
	return result
}
func (_static *CompanionStruct_Default___) BytesBv(bits _dafny.Sequence) _dafny.Sequence {
	return _dafny.SeqCreate((_dafny.IntOfUint32((bits).Cardinality())).Uint32(), func(coer32 func(_dafny.Int) uint8) func(_dafny.Int) interface{} {
...
func (_static *CompanionStruct_Default___) WriteSetPermutations() {
	var _0_configs m_JSON_Values.JSON
	_ = _0_configs
	_0_configs = Companion_Default___.GetConfigs()
	var _1_records _dafny.Sequence
	_ = _1_records
	var _out0 _dafny.Sequence
	_ = _out0
	_out0 = Companion_Default___.GetRecords()
	_1_records = _out0
	var _2_whole m_JSON_Values.JSON
	_ = _2_whole
	_2_whole = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("RoundTripTest"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("Records"), m_JSON_Values.Companion_JSON_.Create_Array_(_1_records)), _dafny.TupleOf(_dafny.SeqOfString("Configs"), _0_configs))))))
	var _3_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _3_valueOrError0
	_3_valueOrError0 = m_JSON_API.Companion_Default___.Serialize(_2_whole)
	if !(!((_3_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/WriteSetPermutations.dfy(134,21): " + (_3_valueOrError0).String())
	}
	var _4_jsonBytes _dafny.Sequence
	_ = _4_jsonBytes
	_4_jsonBytes = (_3_valueOrError0).Extract().(_dafny.Sequence)
	var _5_jsonBv _dafny.Sequence
	_ = _5_jsonBv
	_5_jsonBv = Companion_Default___.BytesBv(_4_jsonBytes)
	var _6_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _6_valueOrError1
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_FileIO.Companion_Default___.WriteBytesToFile(_dafny.SeqOfString("PermTest.json"), _5_jsonBv)
	_6_valueOrError1 = _out1
	if !(!((_6_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/WriteSetPermutations.dfy(137,13): " + (_6_valueOrError1).String())
	}
	var _7___v0 _dafny.Tuple
	_ = _7___v0
	_7___v0 = (_6_valueOrError1).Extract().(_dafny.Tuple)
}
