// Package TestWrappedDDBEncryptionMain
// Dafny module TestWrappedDDBEncryptionMain compiled into Go
...
func (*Default__) String() string {
	return "TestWrappedDDBEncryptionMain.Default__"
}
...
func (_static *CompanionStruct_Default___) ASDF() {
	m_WrappedDDBEncryptionMain.Companion_Default___.ASDF()
}
